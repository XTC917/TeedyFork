...
public class Constants {
     ...
     */
    public static final String BASE_FUNCTION_ADMIN = "ADMIN";

    /**
     * Default storage quota in bytes (100GB).
     */
    public static final long DEFAULT_STORAGE_QUOTA = 100L * 1024 * 1024 * 1024;
     ...
     */
    public static final String USER_REQUEST_STATUS_PENDING = "P";

    /**
     * User request status: Accepted.
     */
    public static final String USER_REQUEST_STATUS_ACCEPTED = "A";

    /**
     * User request status: Rejected.
     */
    public static final String USER_REQUEST_STATUS_REJECTED = "R";
}
